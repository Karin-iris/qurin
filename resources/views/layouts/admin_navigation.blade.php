        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('examination.index')" :active="request()->routeIs('examination.index')">
                        {{ __('Examinations') }}
                    </x-nav-link>
                    @endif
                    ...
                    <x-nav-link :href="route('user.admin_index')" :active="request()->routeIs('user.admin_index')">
                        {{ __('Admin') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                           {{ \Crypt::decryptString(Auth::guard('admin')->user()->name) }}
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.admin_edit')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        <!-- Authentication -->
