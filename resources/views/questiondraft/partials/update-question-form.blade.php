<section>
    ...
    <form method="post" action="{{ route('questiondraft.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="topic" type="text" class="mt-1 block w-full" required autofocus
                          autocomplete="name"/>
        ...
        <div>
            ...
            <x-textarea cols="30" rows="4" id="aaa" name="text" class="mt-1 block w-full" required autofocus
                        autocomplete="name"/>
            <x-input-error class="mt-2" :messages="$errors->get('name')"/>
        </div>
        ...
        <div>
            ...
            <x-textarea cols="30" rows="4" id="aaa" name="aaa" class="mt-1 block w-full" required autofocus
                        autocomplete="name"/>
            <x-input-error class="mt-2" :messages="$errors->get('name')"/>
        </div>
